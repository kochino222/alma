 (() => {
    ...
    class BootScene extends Phaser.Scene {
      ...
      makePlayer() {
        ...
        g.generateTexture("player", 32, 46);
        g.destroy();
      }
      ...
      makeBomb() {
        const g = this.make.graphics({ x: 0, y: 0, add: false });
        g.fillStyle(0x151820, 1); g.fillCircle(12, 14, 10);
        g.lineStyle(2, 0x6d7480, 1); g.strokeCircle(12, 14, 10);
        g.lineStyle(3, 0xd39b52, 1); g.beginPath(); g.moveTo(16, 6); g.lineTo(20, 1); g.strokePath();
        g.fillStyle(0xffd45e, 1); g.fillCircle(21, 1, 2);
        g.generateTexture("bomb", 24, 26); g.destroy();
      }

      makePot() {
        const g = this.make.graphics({ x: 0, y: 0, add: false });
        g.fillStyle(0xb76d47, 1); g.fillRoundedRect(5, 7, 22, 23, 6);
        g.fillStyle(0xe09a69, 0.75); g.fillRect(3, 4, 26, 6);
        g.lineStyle(2, 0x663526, 1); g.strokeRoundedRect(5, 7, 22, 23, 6);
        g.lineStyle(1, 0xf5c08a, 0.6); g.lineBetween(9, 12, 22, 25);
        g.generateTexture("pot", 32, 32); g.destroy();
      }
